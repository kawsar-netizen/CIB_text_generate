        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h4>CIB Data Text Generate In System For Contract</h4>
                </div>

                <div class="ibox-content">
                    @include('sbs2.partials.messages')
                    <span class="form-message"></span>
                        <form class="form-horizontal" name="info" action="{{route('contract_text')}}" method="POST">
                            @csrf
                            {{-- <div class="form-group row">
                                <label class="col-md-12">Branches</label>
                                <div class="col-md-10">
                                    <select class="form-control select2 report_branch_code" name="report_branch_code" id="report_branch_code">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" type="date"  name="cib_date" required placeholder="Enter reporting date" id="cib_date">
                                </div>
                            </div>       --}}
                            <div class="form-group row">
                                <div class="col-md-12">
                            ...
                            <div class="tile-footer">
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-3">
                                        ...
                                        {{-- <a href="http://localhost/final_cib_text_generate/contract.php" onclick="window.open('http://localhost/final_cib_text_generate/contract.php?g_date='+document.info.cib_date.value+'&branch='+document.info.report_branch_code.value,'newwindow', 'width=700, height=450'); return false;" class="btn btn-primary"><i class="fa fa-fw fa-lg fa-check-circle"></i>Download</a> --}}
                                        {{-- <a onClick="window.open('../../operation/abblCashVoucher/voucherForCommissionReport.php?br_code=<?php echo $r1['br_code'];?>&auth_date=<?php echo $r1['auth_date'];?>&exchangeHouseCode=<?php echo $exchangeHouse;?>&auth_user=<?php echo $user;?>','pagename','resizable,height=560,width=1020'); return false;" href="#">Print</a> --}}
                                    </div>
                                </div>
                            </div>
                        </form>
