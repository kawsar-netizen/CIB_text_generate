@php
    ...
    $date = Date('Y_m');
    $line = 'public/cib/contracts/contract' . '_' . $date . '.txt';
    // $filename_txt='contract' . '_' . $date . '.txt';
    ...
    // $sql = "SELECT * FROM cib_installments_contracts WHERE month_no = '$year_month' $report_branch_code_query";
    // $sql = "SELECT * FROM cib_installments_contracts WHERE report_branch_code = '$report_branch_code' AND month_no = '$year_month'";
    // $sql = "SELECT * FROM cib_installments_contracts WHERE month_no = '$year_month'";
    ...
    // $sql = "SELECT * FROM cib_links_guarantor_coborrower WHERE created_at = '$year_month' $report_branch_code_query";
    // $sql = "SELECT * FROM cib_links_guarantor_coborrower WHERE month_no = '$year_month'";
    ...
    // $sql = "SELECT * FROM cib_noninstall_contracts WHERE month_no = '$year_month' $report_branch_code_query";
    // $sql = "SELECT * FROM cib_noninstall_contracts WHERE report_branch_code = '$report_branch_code' AND month_no = '$year_month'";
    // $sql = "SELECT * FROM cib_noninstall_contracts WHERE month_no = '$year_month'";
...
where
    ...
    $f_record_type = 'Q';
    $f_fi_code = '045';
    $f_accounting_date = date('tmY', strtotime($year_month));
                        ...
                        <form autocomplete="off" action="{{ route('contract_text') }}" method="post" class="pull-form">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    ...
                                    <row>
                                        <h4 style="color: red">Contract Text file is generated successfully</h4>
                                        <br>
                                    </row>
                                    <div class="row">
